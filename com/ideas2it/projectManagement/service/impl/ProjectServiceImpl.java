...
public class ProjectServiceImpl implements ProjectService{
    ...
    public List<List> getProjectEmployees(int projectId, List<Integer> employeesId) {
        ...
        List<Integer> alreadyAssignedEmployees = new ArrayList<Integer>();
        List<Integer> unAssignedEmployees = new ArrayList<Integer>();
        ...
        if (projectAssignedEmployees == null) {
            employeeProjectAssignedDetails.add(employeesId);
        } else {
            for (int employeeId : employeesId) {
                if(projectAssignedEmployees.contains(employeeId)) {
                    alreadyAssignedEmployees.add(employeeId);
                } else {
                    unAssignedEmployees.add(employeeId);
                }
            }
            employeeProjectAssignedDetails.add(alreadyAssignedEmployees);
